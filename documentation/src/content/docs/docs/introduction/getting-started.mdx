...
This section will briefly detail some of the endpoints that <a href="/" id="link" class="no-underline">Countries Sundries</a> generally allows.
...
To do this, first visit the <a href="/docs/introduction/get-api-key/" id="link" class="no-underline">Get Access API Key</a> section.
...
To see if you have them updated, <a href='/docs/api-reference/global-header-parameters/' id="link" class="no-underline">Click here!</a>
...
In all endpoints ending in `all` the <a href="/docs/api-reference/global-query-parameters/" id="link" class="no-underline">Global Query Parameters</a> are present and available for use.
The <a href="/docs/api-reference/global-query-parameters/" id="link" class="no-underline">Global Query Parameters</a>, in summary, serve to specify a limited number of records that we will want to bring, to filter by different fields or specify the order of the records.

>The resources with the `details` endpoint enabled are:
>+ Country (to see more, <a href="/docs/api-docs/country/" id="link" class="no-underline">click here!</a>)
>+ Coat Of Arm (to see more, <a href="/docs/api-docs/coat-of-arm/" id="link" class="no-underline">click here!</a>)
>+ Flag (to see more, <a href="/docs/api-docs/flag/" id="link" class="no-underline">click here!</a>)
>+ Currency (to see more, <a href="/docs/api-docs/currency/" id="link" class="no-underline">click here!</a>)
>+ Region (to see more, <a href="/docs/api-docs/region/" id="link" class="no-underline">click here!</a>)
>+ Subregion (to see more, <a href="/docs/api-docs/sub-region/" id="link" class="no-underline">click here!</a>)
...
In this example, we are creating an asynchronous arrow function that will search for the URL <a href="/" id="link" class="no-underline">Country Sundries</a> with the endpoint `country/all`.\
...
For this example we will show a part of the endpoint's full response (to see the full response, <a href="/docs/api-docs/country/" id="link" class="no-underline">click here!</a>
