...
<span class="flex items-center my-5">
  ...
  <a href="http://localhost:3000/v1/auth/google/login" target="_blank" id="link" class="flex items-center no-underline">Click here! <span class="icon-[flat-color-icons--google] ml-1 text-xl"></span></a>
</span>