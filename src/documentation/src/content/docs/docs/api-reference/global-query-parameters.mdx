...
+ `country/all` (see <a href="/docs/api-docs/country/" class="no-underline">Country</a>)
+ `coat-of-arm/all` (see <a href="/docs/api-docs/coat-of-arm/" class="no-underline">Coat of Arm</a>)
+ `flag/all` (see <a href="/docs/api-docs/flag/" class="no-underline">Flag</a>)
+ `currency/all` (see <a href="/docs/api-docs/currency/" class="no-underline">Currency</a>)
+ `region/all` (see <a href="/docs/api-docs/region/" class="no-underline">Region</a>)
+ `sub-region/all` (see <a href="/docs/api-docs/sub-region/" class="no-underline">Sub Region</a>)
