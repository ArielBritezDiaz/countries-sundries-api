...
const $$Profile = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.cookies.has("id_user")) {
    ...
    const fetchData = async () => {
      const response = await fetch(`https://countries-sundries-940e81ckl-arielbritezdiaz.vercel.app/api/v1/user/profile?id_user=${id_user}`, {
        method: "GET",
        headers: {
          "x-api-version": "1",
