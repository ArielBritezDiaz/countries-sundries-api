...
INSERT INTO Country(
    ...
    ('Burundi', 'Republic of Burundi', 'BDI', '.bi', 'Unity, Work, Progress', 'L''Hymne du Burundi', 'Gitega', 'Kirundi, French', 13238559, 'BI', 'BDI', '+257', 'UTC+2', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Bermuda', 'Bermuda', 'BMU', '.bm', 'Quo Fata Ferunt', 'God Save the King', 'Hamilton', 'English', 64019, 'BM', 'BMU', '+1441', 'UTC-4', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Brunei', 'Brunei Darussalam', 'BRN', '.bn', 'Selalu dalam Bimbingan Allah', 'Allah Pemelihara Sultan', 'Bandar Seri Begawan', 'Malay', 452523, 'BN', 'BRN', '+673', 'UTC+8', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Bolivia', 'Plurinational State of Bolivia', 'BOL', '.bo', 'Libertad, Igualdad, Fraternidad', 'Himno Nacional de Bolivia', 'Sucre (constitutional), La Paz (administrative)', 'Spanish, Quechua, Aymara, Guaraní', 12440603, 'BO', 'BOL', '+591', 'UTC-4', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Brazil', 'Federative Republic of Brazil', 'BRA', '.br', 'Ordem e Progresso', 'Order and Progress', 'Brasilia', 'Portuguese', 216422446, 'BR', 'BRA', '+55', 'UTC+3', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Bahamas', 'Commonwealth of The Bahamas', 'BHS', '.bs', 'Forward, Upward, Onward Together', 'March On, Bahamaland', 'Nassau', 'English', 412623, 'BS', 'BHS', '+1242', 'UTC-5', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Djibouti', 'Republic of Djibouti', 'DJ', '.dj', 'Unité, Égalité, Paix', 'We arise with strength! for we have raised our flag', 'Djibouti City', 'Arabic, French', 0, 'DJ', 'DJI', '+253', 'UTC', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Dominican Republic', 'Dominican Republic', 'DO', '.do', 'Dios, Patria, Libertad', 'Himno Nacional', 'Santo Domingo', 'Spanish', 0, 'DO', 'DOM', '+1-809', 'UTC', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Algeria', "People's Democratic Republic of Algeria", 'DZ', '.dz', 'بالشعب وللشعب وبالشعب المصري', 'Kassaman', 'Algiers', 'Arabic, Berber', 0, 'DZ', 'DZA', '+213', 'UTC', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Eritrea', 'State of Eritrea', 'ER', '.er', 'ሃገራ ከምሳዊ ለደናት ኣንሓኪ ከተባብራ ሓቅኛታ', 'ኤርትራው ሓቆ ወደገደላው ትትትሞላ', 'Asmara', 'Tigrinya', 3612706, 'ER', 'ERI', '+291', 'UTC+3', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Fiji', 'Republic of Fiji', 'FJ', '.fj', 'Fiji, the Way the World Begins', 'God Bless Fiji', 'Suva', 'English', 1013952, 'FJ', 'FJI', '+679', 'UTC+12', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Faroe Islands', 'Føroyar', 'FO', '.fo', '', 'Tú alfagra land mítt', 'Tórshavn', 'Faroese', 54987, 'FO', 'FRO', '+298', 'UTC+0', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Guernsey', 'Bailiwick of Guernsey', 'GG', '.gg', 'Dieu est mon droit', 'God Save the Queen', 'St. Peter Port', 'English', 67523, 'GG', 'GGY', '+44', 'UTC+0', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Hong Kong', "Hong Kong Special Administrative Region of the People's Republic of China", 'HK', '.hk', '', 'March of the Volunteers', 'Central', 'Chinese (Traditional)', 7552500, 'HK', 'HKG', '+852', 'UTC+8', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Haiti', 'Republic of Haiti', 'HT', '.ht', "L'Union Fait la Force", 'La Dessalinienne', 'Port-au-Prince', 'French', 12648000, 'HT', 'HTI', '+509', 'UTC-5', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Israel', 'State of Israel', 'IL', '.il', '', 'Hatikvah', 'Jerusalem', 'Hebrew', 9582000, 'IL', 'ISR', '+972', 'UTC+2', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Isle of Man', 'Isle of Man', 'IM', '.im', 'Quocunque Jeceris Stabit', 'Arrane Ashoonagh dy Vannin', 'Douglas', 'English', 85424, 'IM', 'IMN', '+44', 'UTC+0', NULL, NULL, NULL, NULL, NULL, NULL),
    ('India', 'Republic of India', 'IN', '.in', 'Satyameva Jayate', 'Jana Gana Mana', 'New Delhi', 'Hindi', 1444215000, 'IN', 'IND', '+91', 'UTC+5:30', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Iraq', 'Republic of Iraq', 'IQ', '.iq', '', 'Mawtini', 'Baghdad', 'Arabic', 41147072, 'IQ', 'IRQ', '+964', 'UTC+3', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Jersey', 'Bailiwick of Jersey', 'JE', '.je', '', 'God Save the Queen', 'Saint Helier', 'English', 100800, 'JE', 'JEY', '+44', 'UTC+1', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Tonga', 'Kingdom of Tonga', 'TO', '.to', '', 'Ko e fasi ʻo e tuʻi ʻo e ʻOtu Tonga', 'Nukuʻalofa', 'Tongan', 105695, 'TO', 'TON', '+676', 'UTC+13', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Tuvalu', 'Tuvalu', 'TV', '.tv', '', 'Tuvalu mo te Atua', 'Vaiaku village', 'Tuvaluan', 11792, 'TV', 'TUV', '+688', 'UTC+12', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Tanzania', 'United Republic of Tanzania', 'TZ', '.tz', '', 'Mungu ibariki Afrika', 'Dar es Salaam; Dodoma', 'Swahili', 64387033, 'TZ', 'TZA', '+255', 'UTC+3', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Ukraine', 'Ukraine', 'UA', '.ua', '', 'Ще не вмерла України', 'Kyiv', 'Ukrainian', 44134695, 'UA', 'UKR', '+380', 'UTC+2', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Uganda', 'Republic of Uganda', 'UG', '.ug', '', 'Oh Uganda, Land of Beauty', 'Kampala', 'English', 48435343, 'UG', 'UGA', '+256', 'UTC+3', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Vanuatu', 'Republic of Vanuatu', 'VU', '.vu', '', 'We Are Proud to Stand Beside You', 'Port Vila', 'Bislama', 322957, 'VU', 'VUT', '+688', 'UTC+11', NULL, NULL, NULL, NULL, NULL, NULL),
    ('Samoa', 'Independent State of Samoa', 'WS', '.ws', 'Fa''avae le Atua Samoa', 'The Banner of Freedom', 'Apia', 'Samoan', 201498, 'WS', 'WSM', '+685', 'UTC+13', NULL, NULL, NULL, NULL, NULL, NULL),
